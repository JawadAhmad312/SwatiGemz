...
function AddRing() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      ...
      <h1 className="text-2xl font-semibold mb-6 dark:text-gray-900">Add Product</h1>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <input
              ...
              className="w-full border border-gray-400 p-2  text-gray-600 outline-none rounded-md mt-3 dark:text-gray-900"
            />
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={5}
              className="w-full border rounded mt-3 mb-2 border-gray-400 p-2  text-gray-600 outline-none dark:text-gray-900"
            />
          ...
          {/* IMAGE UPLOAD */}
            ...
            <div className="bg-white p-6 rounded-xl shadow">
              ...
              <p className="text-gray-500 mb-3 font-medium dark:text-gray-900">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <input
              ...
              value={ring.price}
              onChange={handleChange}
              className="w-full border border-gray-400 p-2  text-gray-600 outline-none rounded-lg mt-3 dark:text-gray-900"
            />
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <input
              ...
              value={ring.ringSize}
              onChange={handleChange}
              className="w-full border border-gray-400 p-2  text-gray-600 outline-none rounded-lg mt-1 dark:text-gray-900"
            />
            ...
            <label className="flex gap-2 mt-3 dark:text-gray-900">
              <input
                type="checkbox"
                name="isFeatured"
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            <h2 className="text-lg font-semibold dark:text-gray-900">Category</h2>
