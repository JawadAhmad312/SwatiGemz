  ...
  return (
    <>
      ...
      <div className='w-full h-auto mt-[2rem] text-center'>
        <h1 className='text-[28px] md:text-5xl font-bold abril-fatface-regular bg-gradient-to-r from-[#092805] to-[#224225] bg-clip-text text-transparent'>Personalized Gemstone <br /> Recommendation</h1>
